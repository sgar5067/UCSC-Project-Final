...
def normalized_dist_sim(d, g1, g2, dec_gsize=False):
    if logging_enabled == True:
        print("- Entered dist-sim::normalized_dist_sim Global Method")
...
def unnormalized_dist_sim(d, g1, g2, dec_gsize=False):
    if logging_enabled == True:
        print("- Entered dist-sim::unnormalized_dist_sim Global Method")
...
def map_node_type_to_float(g):
    if logging_enabled == True:
        print("- Entered dist-sim::map_node_type_to_float Global Method")
...
def _get_label_map(g1, g2, label_key):
    if logging_enabled == True:
        print("- Entered dist-sim::_get_label_map Global Method")
...
def mcis_edge_map_from_nodes(g1, g2, node_mapping):
    if logging_enabled == True:
        print("- Entered dist-sim::mcis_edge_map_from_nodes Global Method")
...
def write_mivia_input_file(graph, filepath, labeled, label_key, label_map):
    if logging_enabled == True:
        print("- Entered dist-sim::write_mivia_input_file Global Method")
...
def get_mcs_info_cpp(g1, g2, mivia_edge_mapping):
    if logging_enabled == True:
        print("- Entered dist-sim::get_mcs_info_cpp Global Method")
...
def node_id_map_to_label_map(g1, g2, node_id_map):
    if logging_enabled == True:
        print("- Entered dist-sim::node_id_map_to_label_map Global Method")
...
def get_node_id_map_from_edge_map(id_edge_map1, id_edge_map2, edge_mapping):
    if logging_enabled == True:
        print("- Entered dist-sim::get_node_id_map_from_edge_map Global Method")
...
def get_id_edge_map(graph):
    if logging_enabled == True:
        print("- Entered dist-sim::get_id_edge_map Global Method")
...
def get_mcs_path():
    if logging_enabled == True:
        print("- Entered dist-sim::get_mcs_path Global Method")
...
def write_java_input_file(g1, g2, algo, filepath):
    ...
    if logging_enabled == True:
        print("- Entered dist-sim::write_java_input_file Global Method")
...
def graph_as_dict(graph):
    if logging_enabled == True:
        print("- Entered dist-sim::graph_as_dict Global Method")
